...
{{--        <p class="hero-job"><span>I'M A CREATIVE WEB DEVELOPER</span></p>--}}
        <p class="hero-job-desc">Building the Web, One Line of Code at a Time</p>
...
{{--    <!-- End History section -->--}}
    ...
    <section class="site-section section-contact" id="contact">
        <div class="container">
            ...
            <div class="row">
                <form action="/contact-us" method="post" class="form-horizontal" enctype='multipart/form-data'
